  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden pt-28 pb-16 sm:pt-32 lg:pt-36 lg:pb-24">
        ...
        <div className="pointer-events-none absolute -top-48 left-1/2 h-[640px] w-[1100px] -translate-x-1/2 rounded-full opacity-[0.18] blur-[140px]" style={{ background: "conic-gradient(from 90deg, #0195ff, #33aaff, #22d3ee, #0073cc, #0195ff)" }} aria-hidden />
        <div className="container-x relative grid items-center gap-12 lg:grid-cols-[1.05fr_1fr]">
          <div>
            <Link href="/solutions/web2-web3-fintech" className="chip mb-8">
              <span className="size-1.5 rounded-full bg-brand-teal" /> New: Web2 + Web3 FinTech architecture <ArrowRight className="size-3" />
            </Link>
