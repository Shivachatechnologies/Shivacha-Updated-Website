...
const cfg: Record<PreviewKind, PreviewConfig> = {
  ...
  exchange: { title: "BTC-USD", nav: ["Markets", "Trade", "Orders", "Wallets", "Admin"], stats: [["Pair", "BTC-USD"], ["Order types", "Limit · Market · Stop"], ["Book", "Live depth"]], chart: "candles", table: { cols: ["Price", "Size", "Side"], rows: [["Ask", "0.420", "Sell"], ["Ask", "1.105", "Sell"], ["Bid", "0.880", "Buy"]] }, accent: "#2fd6ee" },
